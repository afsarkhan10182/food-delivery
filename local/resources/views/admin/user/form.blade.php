...
<div class="form-group col-md-3">
    ...
    {!! Form::text('postcode',null,['required' => 'required','placeholder' => 'Postal code','class' => 'form-control'])!!}
    </div>
</div>
...
<div class="form-group col-md-3">
    ...
    <div class="form-group col-md-3">
        <select id="validate_period" name="validate_period" class="form-control ">
            @for ($i = 1; $i <= 12; $i++)
                <option value="{{ $i }}" @if($data->validate_period == $i) selected @endif>{{ $i.' Months' }}</option>
            @endfor
        </select>
    </div>
@endif
...
<div class="form-row">
    ...
    <div class="form-group col-md-3">
        {!! Form::text('wallet_expire_from',$data['wallet_expire_from'] ? date("m/d/Y", strtotime($data['wallet_expire_from'])): '',['disabled' => 'disabled','placeholder' => 'Wallet credited date','class' => 'js-datepicker form-control',])!!}
    </div>    
    <div class="form-group col-md-1">
    ...
    <div class="form-group col-md-3">
        {{-- @if(isset($admin)) --}}
        {{-- {!! Form::text('wallet_expire_to',$data['wallet_expire_to'] ? date("m/d/Y", strtotime($data['wallet_expire_to'])): '',['disabled' => 'disabled', 'placeholder' => 'Set to date','class' => 'js-datepicker form-control'])!!} --}}
        {{-- @else --}}
        {!! Form::text('wallet_expire_to',$data['balance_amount'] !== '0' ? date('m/d/Y', strtotime('+'.$data['validate_period'].' months', strtotime($data['wallet_expire_from']))): '',['disabled' => 'disabled','placeholder' => 'Set from admin','class' => 'js-datepicker form-control'])!!}
        {{-- @endif --}}
    </div>  
</div>  
</div>
